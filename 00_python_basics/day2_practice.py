...
import numpy as np
my_age = 18
compounds = ['Erastin', 'RSL3', 'Ferrostain-1']
my_compounds = ['宝宝的' + com for com in compounds]
print(my_compounds)
my_compounds = [f"宝宝的{com}" for com in compounds]
print(my_compounds)
#python data transformation practice
data = {
    "compounds" :["Erastin", "RSL3", "Ferrostain-1", "DFO"],
    "target" :["SLC7A11", "GPX4", "Lipid peroxidation", "Iron"],
    "dose_uM" : [10.0, 5.0, 0.5, 100]
}
df = pd.DataFrame(data)
high_dose = df.query("dose_uM > 5")
print(high_dose)
#Homework
#1-1. 去重
